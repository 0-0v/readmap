...
export function CountrySidePanel({ isOpen, onClose, books, country }: CountrySidePanelProps) {
                ...
                {books.map((book, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 py-1 min-w-0">
                      <h3 className="font-bold text-gray-900 dark:text-white text-sm mb-1 group-hover:text-primary transition-colors truncate">
                        {book.title}
                      </h3>
                      ...
                      <p className="text-[11px] font-medium text-gray-400 dark:text-gray-500">
                        <span className="text-primary">★</span> {book.rating.toFixed(1)}
